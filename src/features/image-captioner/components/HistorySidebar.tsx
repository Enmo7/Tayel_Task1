...
export  function HistorySidebar({ history, loading, onCopy }: HistorySidebarProps) {
    
  return (
    <aside className="mx-3 mb-6 mt-2 rounded-xl border border-slate-200 bg-white shadow-sm sm:mx-6 lg:sticky lg:top-16 lg:mx-0 lg:mb-0 lg:h-[calc(100vh-5rem)] lg:w-80 lg:flex-none lg:rounded-none lg:border-y-0 lg:border-r-0 lg:border-l">
      <div className="border-b border-slate-100 p-4 sm:p-5 m">
